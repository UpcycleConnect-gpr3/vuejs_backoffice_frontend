...
const icons: Record<string, string> = {
  mobilier:
    'M208,136H176V104h16a16,16,0,0,0,16-16V40a16,16,0,0,0-16-16H64A16,16,0,0,0,48,40V88a16,16,0,0,0,16,16H80v32H48a16,16,0,0,0-16,16v16a16,16,0,0,0,16,16h8v40a8,8,0,0,0,16,0V184H184v40a8,8,0,0,0,16,0V184h8a16,16,0,0,0,16-16V152A16,16,0,0,0,208,136ZM64,40H192V88H64Zm32,64h64v32H96Zm112,64H48V152H208v16Z',
  textile:
  ...
  'papier-carton':
    'M88,112a8,8,0,0,1,8-8h80a8,8,0,0,1,0,16H96A8,8,0,0,1,88,112Zm8,40h80a8,8,0,0,0,0-16H96a8,8,0,0,0,0,16ZM232,64V184a24,24,0,0,1-24,24H32A24,24,0,0,1,8,184.11V88a8,8,0,0,1,16,0v96a8,8,0,0,0,16,0V64A16,16,0,0,1,56,48H216A16,16,0,0,1,232,64Zm-16,0H56V184a23.84,23.84,0,0,1-1.37,8H208a8,8,0,0,0,8-8Z',
  autre:
...
// The forum Category has no `slug` field, so derive one locally from the name
// purely to pick an icon — it is never sent to the backend.
function localSlugify(name: string) {
  return name
    .toLowerCase()
    .normalize('NFD')
    .replace(/[̀-ͯ]/g, '')
...
function iconFor(name: string) {
  return icons[localSlugify(name)] ?? icons['autre']
}
</script>
    ...
    <main class="dashboard-main">
      <div class="dashboard-row" style="align-items: center; justify-content: space-between">
        ...
        <div style="display: flex; align-items: center; gap: var(--gap-medium)">
          ...
          <button class="secondary small" @click="openCreate">+ Créer une catégorie</button>
        </div>
      </div>
          ...
          <div style="display: flex; align-items: flex-start; justify-content: space-between">
            <div class="icon-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor">
                <path :d="iconFor(cat.name)" />
              </svg>
            </div>
            <div style="display: flex; gap: var(--gap-small)">
              <button class="small-square ghost" title="Modifier" @click="openEdit(cat)">
                <svg
